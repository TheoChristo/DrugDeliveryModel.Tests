...
{
    public class Eq9ModelProviderForStaggeredSolutionex6
    {
        ...
        public Eq9ModelProviderForStaggeredSolutionex6(ComsolMeshReader comsolReader, double sc, double miNormal, double kappaNormal, double miTumor,
