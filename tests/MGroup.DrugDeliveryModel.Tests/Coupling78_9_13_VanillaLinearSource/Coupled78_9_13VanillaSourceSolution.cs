...
namespace MGroup.DrugDeliveryModel.Tests.Integration
{
    public class Coupled78_9_13VanillaSourceSolution
    {
        ...
        const double totalTime = 40E-5; // in sec
        ...
        public void MonophasicEquationModel(string fileName, double diffusionFactor)
        {
            ...
            for (currentTimeStep = 0; currentTimeStep < totalTime / timeStep; currentTimeStep++)
            {
                ...
                //gp_dut_dx_OverTime[currentTimeStep] = velocityDivergenceAtElementGaussPoints[solidVelocityGPId][0];
                //gp_dvt_dy_OverTime[currentTimeStep] = velocityDivergenceAtElementGaussPoints[solidVelocityGPId][1];
                //gp_dwt_dz_OverTime[currentTimeStep] = velocityDivergenceAtElementGaussPoints[solidVelocityGPId][2];
                gp_div_v_OverTime[currentTimeStep] = velocityDivergenceAtElementGaussPoints[solidVelocityGPId][0];
            ...
            var patSelection = 0;
            var outputPath = patSelection == 0 ? "../../../Coupling78_9_13/results/" : $@"C:\Users\acivi\Documents\atuxaia\develop yperelastic withh BIO TEAM\VALIDATION EQs1\staggered_ex5\";
