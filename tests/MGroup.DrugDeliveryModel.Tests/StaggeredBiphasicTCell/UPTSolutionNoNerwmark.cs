...
{
    public class UPTSolutionNoNerwmark
    {
        const double Sc = 0.1;
        ...
        public void MonophasicEquationModel(string fileName)
        {
            ...
            var equationModel = new CoupledUPNoNewmarkT(pressureModel, structuralModel, tCellModel, comsolReader, lambda,
