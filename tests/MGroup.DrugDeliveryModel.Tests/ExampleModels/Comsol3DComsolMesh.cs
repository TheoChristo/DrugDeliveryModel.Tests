...
namespace ConvectionDiffusionTest
{
    public static class Comsol3DComsolMesh
    {
		...
		public static Model CreateModelFromComsolFileNonLinear(string filename, double capacityCoeff, double diffusionCoeff, double[] convectionCoeff, double independentSourceCoeff,
			 Func<double, double> ProductionFunction, Func<double, double> ProductionFunctionDerivative)
		{
			double dependentSourceCoeff = 0;
